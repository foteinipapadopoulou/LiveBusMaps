...
public class Publisher extends com.example.myapplication.domain.Publisher implements Serializable {
    ...
    public void readTXT(int i,int Nbuses) throws IOException {
        ...
        String[] elements;
        try {
            f = new FileReader(prefix+ "com/example/myapplication/domain/DS_project_dataset/busLinesNew.txt");
        ...
        Bus b;
        String id;
        f=new FileReader(prefix+ "com/example/myapplication/domain/DS_project_dataset/busPositionsNew.txt");
        ...
        br.close();
        f.close();
        f=new FileReader(prefix+ "com/example/myapplication/domain/DS_project_dataset/RouteCodesNew.txt");
        br=new BufferedReader(f);
